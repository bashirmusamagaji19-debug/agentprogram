...
- 构建版本化 deterministic fixture 评测与离线复现入口：10/10 Agent 循环终止、HITL 3/3 pause、reject/duplicate effects 0；项目当前 `422 passed`、`89.83%` coverage，并提供 Streamlit 运行台、`--portfolio-demo` 与 `--release-check`。
