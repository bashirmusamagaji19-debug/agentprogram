    ...
    decisions = [
        AgentDecision(
            ...
            source=(
                ...
                if action is AgentAction.SEARCH_JOBS and planner[1]
...
def build_deterministic_benchmark_cases() -> list[AgentBenchmarkCase]:
    specs = [
        ...
        (
            "search-filtering",
            "Search results filter non-job links",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.EXTRACT_TEXT,
        ...
        (
            "open-recovery",
            "First URL fails and second succeeds",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.OPEN_PAGE,
        ...
        (
            "visual-recovery",
            "Weak text routes to visual extraction",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.EXTRACT_TEXT,
        ...
        (
            "unsupported-tool",
            "Unsupported planner action uses policy fallback",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.EXTRACT_TEXT,
        ...
        (
            "invalid-json",
            "Malformed planner JSON uses policy fallback",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.EXTRACT_TEXT,
        ...
        (
            "verifier-recovery",
            "Verifier rejection recovers with visual evidence",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.EXTRACT_TEXT,
        ...
        (
            "all-candidates-fail",
            "All candidates fail and terminate cleanly",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.OPEN_PAGE,
        ...
        (
            "target-reached",
            "Target count stops the Agent early",
            [
                AgentAction.SEARCH_JOBS,
                AgentAction.OPEN_PAGE,
                AgentAction.EXTRACT_TEXT,
